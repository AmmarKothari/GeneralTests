...
# local
from derive import l, m_link, Ixx, Iyy, Izz, g, kane, q, u, n, torque

param_syms = []
for par_seq in [l, m_link, Ixx, Iyy, Izz, (g,), torque]:
...
x0 = hstack((radians(45), radians(90.0), zeros(n)))
