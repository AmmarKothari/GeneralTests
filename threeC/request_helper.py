...
Py3cw_request_info_single = Optional[Py3cw_request_info_single_success]  # All possible single value responses
Py3cw_request_info_list = List[Py3cw_request_info_single_success]  # All possible list value responses
Py3cw_request_info = Union[Py3cw_request_info_single, Py3cw_request_info_list]  # All possible responses
...
def check_with_retry(request_func: Callable[[], Py3cw_request_response]) -> Py3cw_request_info:
