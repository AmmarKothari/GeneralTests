...
m1= 0.5;% (kg) Mass of element 1
j1= 3;% (kg-m^2) Moment of Inertia of element 1 about its CM
tau1= 0;% (N-m) External torque applied on element 1

l2= 0.5;% (m)Length of element 2
lc2= 0.25;% (m)Distance of CM of element 2 from source end
m2= 0.25;% (kg) Mass of element 2
...
%% INITIAL CONDITIONS
x_0=1.75*cos(0*d2r)+0.1; % initial x in task space
y_0=1.25*sin(0*d2r)+0.1; % initial y in task space
% x_0=0+.001; % initial x in task space
% y_0=0+.001; % initial y in task space
