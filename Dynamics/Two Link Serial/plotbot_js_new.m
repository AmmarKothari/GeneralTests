...
% aviobj = VideoWriter([txt1,'.avi'],'compression','Cinepak'); % Declare an avi object
V = VideoWriter([txt1,'.avi']); % Declare an avi object
open(V);
...
%     pause(0.03);
    ...
    writeVideo(V,frame); % Step 3: Add frame to avi object
end
close(V) % Close the avi object
hold off
% axis equal;